...
import SendEmailToTheCustomerConfirmingTheRegistrationHandler from "../../Customer/Event/Handler/send-email-to-the-customer-confirming-the-registation.handler";
import SendEmailWhenCustomerChangeAddressHandler from "../../Customer/Event/Handler/send-email-when-customer-change-address.handler";
import SendEmailWhenCustomerIsCreateHandler from "../../Customer/Event/Handler/send-email-when-customer-is-created.handler";
